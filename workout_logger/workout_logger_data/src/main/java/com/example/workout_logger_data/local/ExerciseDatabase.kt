...
import com.example.workout_logger_data.local.entity.MuscleEntity
...
@Database(
    entities = [ExerciseEntity::class, MuscleEntity::class, WorkoutEntity::class, TrackedWorkoutEntity::class],
    version = 1
)
